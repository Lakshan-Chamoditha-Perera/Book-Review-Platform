 ...
 *
 * <p>
 * Defines the contract for user CRUD operations and lookup methods.
 * All implementing classes must return responses wrapped in
 * {@link StandardResponse}
 * to ensure consistent API formatting across the application.
 * </p>
 *
 * <p>
 * This interface is typically implemented by {@code UserServiceImpl} and
 * autowired into controllers or other services.
 * </p>
 *
...
public interface UserService {
     ...
     *
     * @return {@link StandardResponse} containing a list of user data (usually
     *         DTOs)
     ...
     * hashes the password, and persists the user entity.
     * </p>
     *
     * @param userRequestDTO DTO containing user registration details
     *                       (e.g., username, email, password)
     * @return {@link StandardResponse} with the created user details and success
     *         message
     ...
     *
     * <p>
     * Useful for login, password reset password, and profile lookup.
     * </p>
     *
