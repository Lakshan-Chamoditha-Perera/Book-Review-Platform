        ...
        try {
            ...
            if (request.getUsername() == null || request.getUsername().isBlank()) {
                ...
                return StandardResponse.<AuthResponse>builder()
                        ...
                        .error(messageService.getMessage("validation.username.required"))
            ...
            if (request.getEmail() == null || request.getEmail().isBlank()) {
                ...
                return StandardResponse.<AuthResponse>builder()
                        ...
                        .success(false)
                        .message(messageService.getMessage("validation.failed"))
                        .error(messageService.getMessage("validation.email.required"))
                        .timestamp(java.time.LocalDateTime.now())
                        .build();
            }
            ...
            if (request.getPassword() == null || request.getPassword().isBlank()) {
                ...
                return StandardResponse.<AuthResponse>builder()
                        ...
                        .success(false)
                        .message(messageService.getMessage("validation.failed"))
                        .error(messageService.getMessage("validation.password.required"))
                        .timestamp(java.time.LocalDateTime.now())
                        .build();
            }
            ...
            if (request.getRole() == null) {
                ...
                return StandardResponse.<AuthResponse>builder()
                        ...
                        .success(false)
                        .message(messageService.getMessage("validation.failed"))
                        .error(messageService.getMessage("validation.role.required"))
                        .timestamp(java.time.LocalDateTime.now())
                        .build();
            }
            ...
            if (userRepository.findByUsername(request.getUsername()).isPresent()) {
                String message = messageService.getMessage("user.username.taken",
                        request.getUsername());
                logger.warning(message);
                return StandardResponse.<AuthResponse>builder()
                        .status(409)
                        .success(false)
                        .message(messageService.getMessage("user.already.exists"))
                        .error(message)
                        .timestamp(java.time.LocalDateTime.now())
                        .build();
            }
            ...
            if (userRepository.findByEmail(request.getEmail()).isPresent()) {
                String message = messageService.getMessage("user.email.taken", request.getEmail());
                logger.warning(message);
                return StandardResponse.<AuthResponse>builder()
                        .status(409)
                        .success(false)
            ...
            return StandardResponse.<AuthResponse>builder()
                    .status(201)
                    .success(true)
                    .message(messageService.getMessage("auth.registration.successful"))
                    .data(authResponse)
                    .timestamp(java.time.LocalDateTime.now())
                    .build();
        ...
        try {
            ...
            if (user == null || !passwordEncoder.matches(request.getPassword(), user.getPassword())) {
                ...
                return StandardResponse.<AuthResponse>builder()
                        .status(401)
                        .success(false)
                        .message(messageService.getMessage("auth.credentials.invalid"))
                        .error(messageService.getMessage("auth.credentials.invalid"))
                        .timestamp(java.time.LocalDateTime.now())
                        .build();
            }
            ...
            AuthResponse authResponse = new AuthResponse(
                    ...
                    user.getUsername(),
                    userRole,
                    messageService.getMessage("auth.login.successful"));

            return StandardResponse.<AuthResponse>builder()
                    .status(200)
                    .success(true)
                    .message(messageService.getMessage("auth.login.successful"))
                    .data(authResponse)
                    .timestamp(java.time.LocalDateTime.now())
                    .build();
